...
4. From Open Set to Closed Set: Counting Objects by Spatial Divide-and-Conquer
Haipeng Xiong, Hao Lu, Chengxin Liu, Liang Liu, Zhiguo Cao, Chunhua Shen
[pdf] [supp] [bibtex]

5. Self-Training With Progressive Augmentation for Unsupervised Cross-Domain Person Re-Identification
Xinyu Zhang, Jiewei Cao, Chunhua Shen, Mingyu You
[pdf] [supp] [bibtex]

6. Enforcing Geometric Constraints of Virtual Normal for Depth Prediction
Wei Yin, Yifan Liu, Chunhua Shen, Youliang Yan
[pdf] [bibtex]

7. Indices Matter: Learning to Index for Deep Image Matting
Hao Lu, Yutong Dai, Chunhua Shen, Songcen Xu
[pdf] [supp] [bibtex]

8. Exploiting Temporal Consistency for Real-Time Video Depth Estimation
Haokui Zhang, Chunhua Shen, Ying Li, Yuanzhouhan Cao, Yu Liu, Youliang Yan
[pdf] [bibtex]

9. Memorizing Normality to Detect Anomaly: Memory-Augmented Deep Autoencoder for Unsupervised Anomaly Detection
Dong Gong, Lingqiao Liu, Vuong Le, Budhaditya Saha, Moussa Reda Mansour, Svetha Venkatesh, Anton van den Hengel
[pdf] [bibtex]

10. Consensus Maximization Tree Search Revisited
